...
function createDivMenu($menu_item_selected){
		...
		if(getGroupe()=="admin"){
		$toReturn .= '<li '.define_class_menu_item_selected($menu_item_selected,"Administration").'><a href="administration/administration.php">Administration</a></li>';
		}
...
function createDivMenu2($menu_item_selected){
		...
		$toReturn .= '<li class="menu_support"><a href="#">Support: tous les supports</a></li>';
		$toReturn .= '</ul>
		</div>';
