...
<link rel="stylesheet" href="styles/slideshow.css" type="text/css" media="screen"/> <!-- slideshow de frontpage -->
...
<!-- ++++++++++++++++++++++formulaire d'identification++++++++++++++++++++++++++ -->
	...
	<div id="wrap"><!-- debut du wrap pour le stick to bottom footer-->
		...
		<div id="maincontainer"><!-- debut du maincontainer-->
			...
			<?php echo createDivMenu2("Accueil"); ?>
			</div><!-- fin du menucontainer -->
			
			<div id="contentcontainer"><!-- debut du contentcontainer-->
				<div id="left_bar"><!-- debut du main content left-->
				<?php echo createDivSlideShow(); ?>
				<?php echo createDivNews(); ?>
				<?php echo createDivDerniersTests(); ?>
				<?php echo createDivAvis(); ?>
				<?php echo createDivAstuces(); ?>
				<?php echo createDivVideos(); ?>
				<?php echo createDivArticles(); ?>
				</div><!-- fin du content main left -->
				
				<div id="right_bar"><!-- debut du right_bar right-->
				<?php echo createDivPub(); ?>
				<?php echo createDivSocialNetwork(); ?>
