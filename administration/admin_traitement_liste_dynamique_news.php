...
//-------------------sous catégorie---------------------//
if(isset($_GET['id_sous_categorie_news']) && isset($_GET['id_news'])){
	$id_sous_categorie_news = trim(htmlentities(intval($_GET['id_sous_categorie_news'])));
	$id_news = trim(htmlentities(intval($_GET['id_news'])));
	$json = array();
	...
	$requete = 'SELECT scn.sous_categorie_news_image_nom AS sous_categorie_news_image,
			...
			scn.id_sous_categorie_news, nscn.id_news,
...
else if(isset($_GET['id_sous_categorie_news']) && !isset($_GET['id_news'])){
	$id_sous_categorie_news = trim(htmlentities(intval($_GET['id_sous_categorie_news'])));
	$id_news = trim(htmlentities(intval($_GET['id_news'])));
	$json = array();
...
//-------------------plateforme---------------------//
else if(isset($_GET['id_plateforme']) && isset($_GET['id_news'])){
...
//-------------------constructeur---------------------//
else if(isset($_GET['id_constructeur']) && isset($_GET['id_news'])){
...
//-------------------developpeur---------------------//
else if(isset($_GET['id_developpeur']) && isset($_GET['id_news'])){
...
else if(isset($_GET['id_editeur']) && isset($_GET['id_news'])){
...
//-------------------Jeux---------------------//
	...
	if($_GET['operation']=='getAllJeuImage'&& !isset($_GET['id_news'])){
	...
	else if($_GET['operation']=='getAllJeuImage' && isset($_GET['id_news'])){
		...
		$requete = 'SELECT DISTINCT jvpi.image_nom, j.jeu_dossier,j.jeu_nom_generique,p.plateforme_nom_generique,
					...
					AND CONCAT("jeux","/",j.jeu_dossier,"/covers/",jvpi.image_nom) NOT IN (SELECT nimg.url_news_image FROM 2015_news_image AS nimg WHERE nimg.id_news = "'.mysql_real_escape_string($id_news).'")
					AND CONCAT("jeux","/",j.jeu_dossier,"/covers/",jvpi.image_nom) NOT IN (SELECT nillu.url_news_illustration FROM 2015_news_illustration AS nillu WHERE nillu.id_news = "'.mysql_real_escape_string($id_news).'")
	...
	else if($_GET['operation']=='getAllJeuVideo' && !isset($_GET['id_news'])){
