<?php 
require_once('bloc_page_article.php');
...
<!-- ++++++++++++++++++++++formulaire d'identification++++++++++++++++++++++++++ -->
	...
	<div id="wrap"><!-- debut du wrap pour le stick to bottom footer-->
		...
		<div id="maincontainer"><!-- debut du maincontainer-->
			...
			<?php echo createDivMenu("Articles"); ?>
			...
			<div id="contentcontainer"><!-- debut du contentcontainer-->
				...
				echo createDivArticleWithIdArticle($_GET['id_article']);
				} 
				else{
				echo createDivAllArticleWithPageNumber($_GET['page']);
				}
				?>
